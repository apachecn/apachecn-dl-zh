...
1 个 <sup>st</sup> ，11 个 <sup>st</sup> ，21 <sup>st</sup> 和 31 个 <sup>st</sup> 样本被赋予标签`0`，而两个 <sup>第</sup>，第 12 <sup>，第<sup>，第 22</sup> 和第 32 <sup>，第</sup>样品被赋予标签`1`，依此类推。 前 10 个样本被赋予连续值`-3`，接下来的 10 个样本被赋予`-1`，然后被赋予`1`，最后被赋予最后的 10 个样本`3`。 培训超过 50 个纪元如下：</sup>
