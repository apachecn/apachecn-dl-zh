...
训练 Q 网络所需的数据来自代理的经验：![](img/14853_09_055.png)。 每个训练样本都是经验单位![](img/14853_09_056.png)。 在时间步![](img/14853_09_057.png)，![](img/14853_09_058.png)的给定状态下，使用类似于前一部分的 Q 学习算法来确定动作![](img/14853_09_059.png)：
