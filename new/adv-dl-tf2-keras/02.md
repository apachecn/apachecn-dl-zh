...
接下来，我们将在中讨论两个模块之间的差异，以了解更多详细信息。“图 2.2.3”显示了另一个常用的深层网络 **VGG** [3]和 ResNet 的 CNN 块的更多详细信息。 我们将层要素贴图表示为 x。 层`l`的特征图为 x <sub style="font-style: italic;">l</sub> 。 在 CNN 层中的操作是 **Conv2D 批处理规范化（BN）-ReLU** 。
...
| **＃层** |`n`| **在 CIFAR10 上的准确率百分比（原始纸）** | **CIFAR10 的准确率百分比（本书）** |
