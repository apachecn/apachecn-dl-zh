...
由于我们将使用 MI 来估计密度函数，因此 IIC 将采样限制为![](img/B14853_13_048.png)。 本质上，对于每个样本`X`<sub>i</sub> ，我们计算其潜在代码![](img/B14853_13_049.png)。 然后，我们将`X`<sub>i</sub> 转换，并计算其潜在代码![](img/B14853_13_050.png)。 联合分布计算如下：

![](img/B14853_13_051.png) (Equation 13.3.3)

其中`M`是批次大小。 由于我们对`X`<sub>i</sub> 和![](img/B14853_13_053.png)使用相同的编码器![](img/B14853_13_052.png)，因此联合分布应该对称。 我们通过执行以下命令来增强对称性：
