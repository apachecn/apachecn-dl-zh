...
其中`n`<sub style="font-style: italic;">迷你批量</sub>是迷你批量大小，`n`<sub style="font-style: italic;">锚定框</sub>是锚定框的数量。 `for`循环迭代的次数等于`n_layers`。 该数目也等于锚定框缩放因子的所需数目或 SSD 头的特征提取块的数目。
