...
`y`<sub style="font-style: italic;">off</sub> = ((`x`<sub style="font-style: italic;">omin</sub>,`y`<sub style="font-style: italic;">omin</sub>),(`x`<sub style="font-style: italic;">omax</sub>,`y`<sub style="font-style: italic;">omax</sub>)) (Equation 11.4.2)
...
`y`<sub style="font-style: italic;">gt</sub> = (`x`<sub style="font-style: italic;">bmin</sub> –`x`<sub style="font-style: italic;">amin</sub>,`x`<sub style="font-style: italic;">bmax</sub> –`x`<sub style="font-style: italic;">amax</sub>,`y`<sub style="font-style: italic;">bmin</sub> –`y`<sub style="font-style: italic;">amin</sub>,`y`<sub style="font-style: italic;">bmax</sub> –`y`<sub style="font-style: italic;">amax</sub>) (Equation 11.4.3)
...
(w<sub style="font-style: italic;">b</sub>, h<sub style="font-style: italic;">b</sub>) = (`x`<sub style="font-style: italic;">max</sub> –`x`<sub style="font-style: italic;">min</sub>,`y`<sub style="font-style: italic;">max</sub> –`y`<sub style="font-style: italic;">min</sub>) (Equation 11.4.6)
