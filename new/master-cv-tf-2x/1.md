...
如果尚未安装，请从[这里](https://www.anaconda.com)安装 Anaconda。 Anaconda 是 Python 的包管理器。 您还需要使用`pip install opencv-python`为要执行的所有计算机视觉工作安装 OpenCV。 OpenCV 是用于计算机视觉工作的内置编程功能的库。
