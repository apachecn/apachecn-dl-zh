...
2.  **Con** **转换为冻结模型。** 请注意，我们在“第 6 章”，*使用转移学习的视觉搜索*中开发的模型并未冻结。
...
*   **tf.keras 模型格式**：`tf.kears`模型是`tf.keras.model.compile`文件，我们在“第 4 章”，*图像深度学习*和“第 6 章”，*使用转移学习的视觉搜索*。
...
*   **Keras 模型**：以下代码描述了如何使用`history.fit`命令编译 Keras 模型并准备进行训练。 请注意，我们在“第 4 章”，*图像深度学习*和“第 6 章”，*使用转移学习的视觉搜索*中对此进行了编码练习。 ：
