...
我们在“第 5 章”，*神经网络架构和模型*中了解到，Faster R-CNN 包含 21,500 个区域建议（60 x 40 滑动窗口和 9 个锚定框），这些建议被扭曲为 2K 固定层。 这些 2K 层被馈送到全连接层和包围盒回归器，以检测图像中的包围盒。 9 个锚框来自 3 个比例尺，框面积分别为 128 <sup>2</sup> ，256 <sup>2</sup> ，512 <sup>2</sup> 和三个长宽比：1：1、1 ：2 和 2：1。
