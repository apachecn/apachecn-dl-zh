...
第 10 章，“构建类似 AlphaZero 的手机游戏应用程序”，从最新和最酷的 AlphaZero 的工作原理以及如何训练和测试 AlphaZero 的模型开始 在 TensorFlow 作为后端的 Keras 中玩一个简单但有趣的游戏，名为 Connect4。 然后，我们将向您展示完整的 iOS 和 Android 应用程序，以使用该模型并在您的移动设备上玩 Connect4 游戏。
