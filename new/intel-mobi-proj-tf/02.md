...
继续，既然您知道了将强大的 TensorFlow 模型添加到 iOS 应用程序需要做什么，无论它是用 Objective-C 还是 Swift 编写的，都没有理由阻止您将 AI 添加到您的移动应用程序中，除非您是 Android。 但是您知道我们当然也会照顾 Android。
...
既然您已经了解了如何将 TensorFlow 和经过重新训练的模型添加到自己的 iOS 和 Android 应用程序，那么如果想要添加非 TensorFlow 相关功能应该不会太难。例如使用手机的摄像头拍摄狗的照片和识别它的品种。
