...
量化涉及将模型的权重和激活从 float 转换为 int，这可以导致模型尺寸更小，推断速度更快，而对准确性的影响很小。
...
[`Download Jupyter notebook: dynamic_quantization_tutorial.ipynb`](../_downloads/9387e74b1a614d9ed5642654e06b1728/dynamic_quantization_tutorial.ipynb)
