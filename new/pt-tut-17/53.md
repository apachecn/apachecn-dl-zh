...
在本教程中，我们将向您展示如何将 Ray Tune 集成到 PyTorch 训练工作流程中。 我们将从 PyTorch 文档扩展本教程的[，以训练 CIFAR10 图像分类器。](https://pytorch.org/tutorials/beginner/blitz/cifar10_tutorial.html)
