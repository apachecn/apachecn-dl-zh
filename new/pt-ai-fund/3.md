...
您可以在 [https://PyTorch.org/docs/stable/nn.html#torch.nn.Conv2d](https://pytorch.org/docs/stable/nn.html#torch.nn.Conv2d) 了解有关 PyTorch 卷积的其他参数。
...
您可以在 [https://PyTorch.org/docs/stable/nn.html#pooling-layers](https://pytorch.org/docs/stable/nn.html#pooling-layers) 上找到有关池和各种池的更多信息。
...
您可以在 [https://PyTorch.org/docs/stable/torchvision/transforms.html#functional-transforms](https://pytorch.org/docs/stable/torchvision/transforms.html#functional-transforms) 上了解有关功能转换的更多信息。
...
您可以在 [https://PyTorch.org/docs/stable/torchvision/transforms.html](https://pytorch.org/docs/stable/torchvision/transforms.html) 了解有关仿射变换等其他变换的信息。
...
您可以在 [https://PyTorch.org/docs/stable/data.html#module-torch.utils.data](https://pytorch.org/docs/stable/data.html#module-torch.utils.data) 上了解有关数据加载工具的更多信息。
...
您可以在 [https://PyTorch.org/tutorials/beginner/blitz/cifar10_tutorial.html#define-a-convolutional-neural-network](https://pytorch.org/tutorials/beginner/blitz/cifar10_tutorial.html#define-a-convolutional-neural-network) 上看到使用 CNN 训练 CIFAR10 的不同模型。
...
您可以在 [https://PyTorch.org/tutorials/beginner/blitz/cifar10_tutorial.html#test-the-network-on-the-test-data](https://pytorch.org/tutorials/beginner/blitz/cifar10_tutorial.html#test-the-network-on-the-test-data) 上看到测试模型的示例实现。