...
创建帐户后，将为您提供一个仪表板，该仪表板将显示您活动的 Dialogflow 项目或要求您创建要显示的新代理，但是**智能体**是什么？
...
对于小型特工，训练将在几秒钟内完成，并且将为您提供特工训练已完成的通知。
...
5.  现在让我们使用此方法。 首先，声明一条消息以传递给 Dialogflow 代理。 回忆我们为`Dummy Intent`提供给 Dialogflow 代理的训练短语。 我们将传递与训练短语相似的消息：
